...
param(
    ...
    [string]$HealthScript = "C:\Server\zhaojunjie\recognition-card-system\scripts\Test-SqliteBackupHealth.ps1",
...
$expectedHealthScript = "C:\Server\zhaojunjie\recognition-card-system\scripts\Test-SqliteBackupHealth.ps1"
