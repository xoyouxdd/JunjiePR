...
ROLE_PERMISSION_CODES = {
    ...
    "SUPERVISOR": ("EMPLOYEE_ADD", "DEDUCTION_DIRECT", "REVIEW_DIRECT", "MEMBER_RECORDS", "DECLARATION_STATS_VIEW", "DECLARATION_STATS_EXPORT"),
    "TA_GSM": ("EMPLOYEE_ADD", "DEDUCTION_ALL", "DATA_VIEW", "POC_ISSUE", "LOA_REGISTER", "DECLARATION_STATS_VIEW", "DECLARATION_STATS_EXPORT"),
    "GSM": ("EMPLOYEE_ADD", "DEDUCTION_ALL", "DATA_VIEW", "DATA_EXPORT", "PASSWORD_RESET", "POC_ISSUE", "SICK_LEAVE_IMPORT", "LOA_REGISTER", "DECLARATION_STATS_VIEW", "DECLARATION_STATS_EXPORT"),
    "AM": ("DATA_VIEW", "DATA_EXPORT", "PASSWORD_RESET", "POC_ISSUE", "LOA_REGISTER", "DECLARATION_STATS_VIEW", "DECLARATION_STATS_EXPORT"),
